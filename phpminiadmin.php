...
// username: b3ca558c594578
// password: 1dada4fd
// port: 3306
 #DEFAULT db connection settings
 # --- WARNING! --- if you set defaults - it's recommended to set $ACCESS_PWD to protect your db!
 $DBDEF=array(
 'user'=>"b3ca558c594578",#required
 'pwd'=>"1dada4fd", #required
 'db'=>"moviestan",  #optional, default DB
 'host'=>"us-cdbr-azure-west-b.cleardb.com",#optional
 'port'=>"3306",#optional
